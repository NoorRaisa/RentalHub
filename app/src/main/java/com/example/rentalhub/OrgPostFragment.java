...
public class OrgPostFragment extends Fragment {
    ImageButton up;
    int Gallery=1;
    Uri uri;
    ...
    public OrgPostFragment()
    {

    }
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate( R.layout.fragment_org_post, null );
        ...
        up=v.findViewById(R.id.uploadorg);
        name = v.findViewById(R.id.homeNameorg);
        b1 = v.findViewById(R.id.btnorg);
        add=v.findViewById( R.id.addressorg );
        rent = v.findViewById(R.id.rentorg);
        mob = v.findViewById(R.id.mobileorg);
        room = v.findViewById(R.id.roomorg);
        des = v.findViewById(R.id.desorg);
        adv=v.findViewById( R.id.advanceorg );
        ...
        postDataRef.child(randomKey).updateChildren(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete( Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    des.setText( "" );
                    adv.setText( "" );
                    startActivity( new Intent( getContext(), OrgHome.class ) );
                }
                else{
                    pd.dismiss();
